...
int main(int argc, char **argv)
{
    ...
    // indoor flying 
    ros::Publisher event_depth_array_pub = nh_private.advertise<dvs_msgs::EventDepthArray>("/events_depth", 10);
    ...
    bool isEventEmpty = event.eventDepthReader(filename);
    ...
    event.setEventDepthPublisher(&event_depth_array_pub);
